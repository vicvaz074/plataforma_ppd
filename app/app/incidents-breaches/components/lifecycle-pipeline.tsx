...
const stages = [
  {
    ...
    label: "Preparación",
    icon: Shield,
    borderColor: "border-[#1b75bc]",
    iconBg: "bg-[#1b75bc]/10",
    iconColor: "text-[#1b75bc]",
    gradient: "from-[#1b75bc] to-[#1a0b73]",
    activeRing: "ring-[#1b75bc]",
    activeShadow: "shadow-[0_10px_25px_-5px_rgba(27,117,188,0.25),0_8px_10px_-6px_rgba(27,117,188,0.15)]",
    connectorGradient: "from-[#1b75bc] to-[#1e40af]",
    clickable: false,
  },
  {
    id: "identification",
