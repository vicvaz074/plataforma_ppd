...
export default function PrivacyNoticesPage() {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-8">Avisos de privacidad</h1>

      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="mb-4">
          <TabsTrigger value="form">
            {editingNotice ? "Editar aviso" : "Registrar nuevo aviso"}
          </TabsTrigger>
          <TabsTrigger value="list">Avisos registrados</TabsTrigger>
        </TabsList>
